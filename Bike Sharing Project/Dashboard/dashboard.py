...
# Menggunakan decorator cache agar data tidak dibaca ulang setiap kali ada interaksi
@st.cache_data
def load_data():
    # Menyesuaikan path baca data. Mendukung eksekusi dari root maupun dari dalam folder dashboard
    try:
